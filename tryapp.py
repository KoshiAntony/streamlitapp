...
st.sidebar.write("antonykoshi2020@gmail.com")
#rb means converting pdf file to raw binary format
pdf_file = open('Antony_Resume.docx', 'rb')
...
with tab_exp:
    ...
    "Job Title":["Business Analyst","Business Analyst", "Project Coordinator"],
    "Comapnay":["IBS", "Kefi Tech Solutions","Athena Global Education"],
